...
Rcpp::List locally_linear_train(Rcpp::NumericMatrix input_data,
  ...
  ForestTrainer trainer = ForestTrainers::locally_linear_trainer(data, outcome_index, num_covariates, lambda);
...
Rcpp::NumericMatrix locally_linear_predict(Rcpp::List forest,
  ...
  ForestPredictor predictor = ForestPredictors::locally_linear_predictor(num_threads);
